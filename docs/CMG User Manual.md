...
Computer Music Generator (CMG) User's Guide, Version 3.2
========================================================
**Table of Contents**
...
The silent generator, CMG, contains the name of the generator, its type (CMG), and its start and stop times. When the type is changed, the add/edit panel changes to the selected type. 
