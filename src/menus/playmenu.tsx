...
//   // sync the context cursor to the body cursor
//   useEffect(() => {
...
//     setCursor("wait");
//     const { playData, error } = await buildSourceData({
//       mode: playMode,
//       generator: null,
//       fileContents,
//       timeInterval,
...
//         </div>
//       </div>
//       {!!(playData && mode == PLAYMODE.play) && <Play setMode={setMode} />}
//     </>
//   );
// }
