...
export default class SFRG extends CMG {
  ...
  override copy(): SFRG {
    ...
    n.panT = copyTransitions(this.panT);
    return n;
    ...
    function copyProbabilities(
      probabilities: MarkovProbabilities
    ): MarkovProbabilities {
  ...
  override setAttribute(name: string, value: string): void {
    ...
    switch (name) {
      ...
      case "midiT.range.lo":
        ...
        break;
      case "midiT.range.hi":
        this.midiT.range.hi = parseFloat(value);
        break;
      case "midiT.range.step":
        this.midiT.range.step = parseFloat(value);
        break;
      case "midiT.same.same":
        this.midiT.same.same = parseFloat(value);
        break;
      case "midiT.same.up":
        this.midiT.same.up = parseFloat(value);
        break;
      case "midiT.same.down":
        this.midiT.same.down = parseFloat(value);
        break;
      case "midiT.up.same":
        this.midiT.up.same = parseFloat(value);
        break;
      case "midiT.up.up":
        this.midiT.up.up = parseFloat(value);
        break;
      case "midiT.up.down":
        this.midiT.up.down = parseFloat(value);
        break;
      case "midiT.down.same":
        this.midiT.down.same = parseFloat(value);
        break;
      case "midiT.down.up":
        this.midiT.down.up = parseFloat(value);
        break;
      case "midiT.down.down":
        this.midiT.down.down = parseFloat(value);
        break;

      case "speedT.startValue":
        this.speedT.startValue = parseFloat(value);
        break;
      case "speedT.range.lo":
        this.speedT.range.lo = parseFloat(value);
        break;
      case "speedT.range.hi":
        this.speedT.range.hi = parseFloat(value);
        break;
      case "speedT.range.step":
        this.speedT.range.step = parseFloat(value);
        break;
      case "speedT.same.same":
        this.speedT.same.same = parseFloat(value);
        break;
      case "speedT.same.up":
        this.speedT.same.up = parseFloat(value);
        break;
      case "speedT.same.down":
        this.speedT.same.down = parseFloat(value);
        break;
      case "speedT.up.same":
        this.speedT.up.same = parseFloat(value);
        break;
      case "speedT.up.up":
        this.speedT.up.up = parseFloat(value);
        break;
      case "speedT.up.down":
        this.speedT.up.down = parseFloat(value);
        break;
      case "speedT.down.same":
        this.speedT.down.same = parseFloat(value);
        break;
      case "speedT.down.up":
        this.speedT.down.up = parseFloat(value);
        break;
      case "speedT.down.down":
        this.speedT.down.down = parseFloat(value);
        break;

      case "volumeT.startValue":
        this.volumeT.startValue = parseFloat(value);
        break;
      case "volumeT.range.lo":
        this.volumeT.range.lo = parseFloat(value);
        break;
      case "volumeT.range.hi":
        this.volumeT.range.hi = parseFloat(value);
        break;
      case "volumeT.range.step":
        this.volumeT.range.step = parseFloat(value);
        break;
      case "volumeT.same.same":
        this.volumeT.same.same = parseFloat(value);
        break;
      case "volumeT.same.up":
        this.volumeT.same.up = parseFloat(value);
        break;
      case "volumeT.same.down":
        this.volumeT.same.down = parseFloat(value);
        break;
      case "volumeT.up.same":
        this.volumeT.up.same = parseFloat(value);
        break;
      case "volumeT.up.up":
        this.volumeT.up.up = parseFloat(value);
        break;
      case "volumeT.up.down":
        this.volumeT.up.down = parseFloat(value);
        break;
      case "volumeT.down.same":
        this.volumeT.down.same = parseFloat(value);
        break;
      case "volumeT.down.up":
        this.volumeT.down.up = parseFloat(value);
        break;
      case "volumeT.down.down":
        this.volumeT.down.down = parseFloat(value);
        break;

      case "panT.startValue":
        this.panT.startValue = parseFloat(value);
        break;
      case "panT.range.lo":
        this.panT.range.lo = parseFloat(value);
        break;
      case "panT.range.hi":
        this.panT.range.hi = parseFloat(value);
        break;
      case "panT.range.step":
        this.panT.range.step = parseFloat(value);
        break;
      case "panT.same.same":
        this.panT.same.same = parseFloat(value);
        break;
      case "panT.same.up":
        this.panT.same.up = parseFloat(value);
        break;
      case "panT.same.down":
        this.panT.same.down = parseFloat(value);
        break;
      case "panT.up.same":
        this.panT.up.same = parseFloat(value);
        break;
      case "panT.up.up":
        this.panT.up.up = parseFloat(value);
        break;
      case "panT.up.down":
        this.panT.up.down = parseFloat(value);
        break;
      case "panT.down.same":
        this.panT.down.same = parseFloat(value);
        break;
      case "panT.down.up":
        this.panT.down.up = parseFloat(value);
        break;
      case "panT.down.down":
  ...
  getCurrentValue(): {
    ...
    function getNewValue(
      ...
      switch (state) {
        ...
        case MARKOVSTATE.up:
          ...
          if (Math.abs(newValue - currentValue) < EPS) newValue -= limits.step;
          break;
        case MARKOVSTATE.down:
          newValue -= limits.step;
    ...
    this.midiT.currentValue = getNewValue(
      this.midiT.currentValue,
      this.midiT.range,
      this.midiT.currentState
    );
    this.speedT.currentState = changeState(this.speedT);
    this.speedT.currentValue = getNewValue(
      this.speedT.currentValue,
      this.speedT.range,
      this.speedT.currentState
    );
    this.volumeT.currentState = changeState(this.volumeT);
    this.volumeT.currentValue = getNewValue(
      this.volumeT.currentValue,
      this.volumeT.range,
      this.volumeT.currentState
    );
    this.panT.currentState = changeState(this.panT);
    this.panT.currentValue = getNewValue(
      this.panT.currentValue,
      this.panT.range,
      this.panT.currentState
    );
    return {
  ...
  override appendXML(doc: XMLDocument, elem: Element): void {
    ...
    function addTransitionAttributes(
      ...
      const tElement: Element = doc.createElement(name);
      tElement.setAttribute("startValue", transition.startValue.toString());
      const range: Element = doc.createElement("range");
      ...
      const same: Element = doc.createElement("same");
      ...
      const up: Element = doc.createElement("up");
      ...
      const down: Element = doc.createElement("down");
