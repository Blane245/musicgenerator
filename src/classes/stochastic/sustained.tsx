...
export default class Sustained extends Timbre {
    override values: {
        duration: number;
        frequency: TimbreAttribute;
    } = {
        duration: 0,
        frequency: {mean: 0, lo: 0, hi: 0, type: ALGORITHMTYPE.Constant, algorithm: new ConstantValues(0)}
    };
    constructor() {super(TIMBRE.Sustained);}
    override copy(): Sustained {
        const n: Sustained = new Sustained();
