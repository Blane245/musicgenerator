...
export const getGeneratorValues = (izone: InstrumentZone, pzone: PresetZone, preset: Preset): Object => {
  return Object.fromEntries(
    Array.from(
      ...
      .map((key:string) => [generators[key], getGeneratorValue(parseInt(key), izone, pzone.instrument, pzone, preset)]),
  );
};
